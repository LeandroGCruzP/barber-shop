  ...
  return (
    <main className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="flex flex-col gap-8 flex-1">
          ...
          <Form action={e => onSubmit(e)} className="flex flex-col gap-8 w-full max-w-lg">
            <div className="flex flex-col gap-4">
              <input
                ...
                placeholder="Email"
                // required
                className="px-8 bg-transparent h-16 border-2 border-secondary rounded-full text-2xl flex items-center justify-center hover:brightness-125 focus:brightness-125 transition text-white text-shadow-md outline-none"
                autoFocus
              />
              <input
                name="password"
